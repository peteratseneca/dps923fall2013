...
#pragma mark - Factory that creates a fetch request

- (NSFetchRequest *)fetchRequestForEnitityNamed:(NSString *)entityName withPredicateFormat:(NSString *)predicate predicateObject:(id)predicateObject sortDescriptors:(NSString *)sortDescriptors
{
...
{
    // Create the fetch request
    NSFetchRequest *fetchRequest = [self fetchRequestForEnitityNamed:entityName withPredicateFormat:predicate predicateObject:predicateObject sortDescriptors:sortDescriptors];
